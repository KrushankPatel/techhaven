  ...
  return (
    <div>
      ...
      <div className={classes.itemMeta}>
        ...
        <p>{`Timestamp: ${new Date(order.createdAt).toLocaleTimeString()}`}</p>
        <p className={classes.completed}>{`Payment Status: Completed`}</p>
        <p className={classes.deliverydate}>{`Delivery By: ${formattedDeliveryDate}`}</p>
